  ...
  return (
    <>
      ...
      <div className="container max-w-lg gap-3 mx-auto my-10">
        <h1 className="text-4xl font-bold text-center">OV Manipulation Options</h1>
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 my-10">
          <div>
            <input type="radio" id="prePopulated" name="option" value="prePopulated" checked={selectedOption === 'prePopulated'} onChange={handleOptionChange} />
            <label htmlFor="prePopulated" className="ml-2">
              Use pre-populated cert from DB
            </label>
          </div>
          <div className="">
            <input type="radio" id="uploadNew" name="option" value="uploadNew" checked={selectedOption === 'uploadNew'} onChange={handleOptionChange} />
          ...
          <div className="text-right m-10">
            <Button type="submit" btn_type="primary" text="Proceed to extend OV" />
          </div>
        </form>
      </div>
    </>
